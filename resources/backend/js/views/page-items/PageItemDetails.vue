                        ...
                        <div class="row">
                            ...
                            <div class="col col-xs-12 col-sm-12 col-md-12">
                                <div v-if="isText || isFile" class="form-group">
                                    ...
                                    <input v-if="isText" v-model="item.content" name="content" type="text" class="form-control input-sm" placeholder="Content">
                                    <input v-if="isFile" name="content" type="file" class="form-control input-sm">
                                </div>

                                <div v-show="isContent" class="form-group">
                                    <label>Content</label>
                                    <vue-ckeditor v-if="isContent" type="classic" v-model="item.content" :editors="editors"></vue-ckeditor>
                                    <input v-if="isContent"  v-model="item.content" name="content" type="hidden" class="form-control input-sm" placeholder="Content">
