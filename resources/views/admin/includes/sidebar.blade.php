<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      @if ($checker->permission->can(['admin.application', 'admin.application.approve', 'admin.application.destroy']))
        <li class="header">Warranty</li>
        <li><a href="{{ route('admin.application') }}"><i class="fa fa-book"></i> <span>Application</span></a></li>
      @endif

      @if ($checker->permission->can(['admin.discounts', 'admin.discount.create', 'admin.discount.edit', 'admin.discount.destroy']))
        <li><a href="{{ route('admin.discounts') }}"><i class="fa fa-book"></i> <span>Discount</span></a></li>
      @endif

      @if ($checker->permission->can(['admin.request', 'admin.request.create', 'admin.request.edit', 'admin.request.destroy']))
      ...
      @if ($checker->permission->can(['admin.products.index', 'admin.product.create', 'admin.product.edit', 'admin.product.destroy', 'admin.categories.index', 'admin.categories.create', 'admin.categories.edit', 'admin.categories.destroy', 'admin.types.index', 'admin.types.create', 'admin.types.edit', 'admin.types.destroy']))
        ...
        <li class="treeview {{ $checker->route->isActive(['admin.products.', 'admin.product.', 'admin.categories.', 'admin.types.'], 'menu-open') }}">
          ...
          <ul class="treeview-menu {{ $checker->route->isActive(['admin.products.', 'admin.product.', 'admin.categories.', 'admin.types.']) }}">
            ...
            @if ($checker->permission->can(['admin.categories.index', 'admin.categories.create', 'admin.categories.edit', 'admin.categories.destroy']))
            ...
            @if ($checker->permission->can(['admin.types.index', 'admin.types.create', 'admin.types.edit', 'admin.types.destroy']))
      ...
      <li class="treeview {{ $checker->route->isActive(['admin.pages.', 'admin.page-items.', 'admin.carousel.', 'admin.locations.', 'admin.contact', 'admin.faqs.'], 'menu-open') }}">
        ...
        <ul class="treeview-menu {{ $checker->route->isActive(['admin.pages.', 'admin.page-items.', 'admin.carousel.', 'admin.faqs', 'admin.locations.', 'admin.contact']) }}">
          ...
          @if ($checker->permission->can(['admin.pages.index', 'admin.pages.create', 'admin.pages.edit', 'admin.pages.destroy']))
            <li class="{{ $checker->route->isActive('admin.pages.') }}">
              <a href="{{ route('admin.pages.index') }}"><i class="fas fa-boxes"></i> Page</a>
            </li>
          @endif

          @if ($checker->permission->can(['admin.page-items.index', 'admin.page-items.create', 'admin.page-items.edit', 'admin.page-items.destroy']))
          ...
          @if ($checker->permission->can(['admin.carousel.index', 'admin.carousel.create', 'admin.carousel.edit', 'admin.carousel.destroy']))
            <li class="{{ $checker->route->isActive('admin.carousel.') }}">
              <a href="{{ route('admin.carousel.index') }}"><i class="fas fa-images"></i> Slider</a>
            </li>
          @endif

          @if ($checker->permission->can(['admin.faqs.index', 'admin.faqs.create', 'admin.faqs.edit', 'admin.faqs.destroy']))
          <li class="{{ $checker->route->isActive('admin.faqs.') }}">
            <a href="{{ route('admin.faqs.index') }}"><i class="fas fa-question"></i> FAQ</a>
          </li>
          @endif

          @if ($checker->permission->can(['admin.contacts.index', 'admin.contacts.create', 'admin.contacts.edit', 'admin.contacts.destroy']))
          ...
          @if ($checker->permission->can(['admin.locations.index', 'admin.locations.create', 'admin.locations.edit', 'admin.locations.destroy']))
      ...
      @if ($checker->permission->can(['admin.administrator', 'admin.administrator.edit', 'admin.administrator.create', 'admin.administrator.destroy', 'admin.roles', 'admin.roles', 'admin.roles.edit', 'admin.roles.create', 'admin.roles.destroy']))
      ...
      <li class="treeview {{ $checker->route->isActive(['admin.administrator', 'admin.role'], 'menu-open') }}">
        ...
        <ul class="treeview-menu {{ $checker->route->isActive(['admin.administrator.', 'admin.role']) }}">
          ...
          @if ($checker->permission->can(['admin.administrator', 'admin.administrator.edit', 'admin.administrator.create', 'admin.administrator.destroy']))
          ...
          @if ($checker->permission->can(['admin.roles', 'admin.roles.edit', 'admin.roles.create', 'admin.roles.destroy']))
      ...
      @if ($checker->permission->can(['admin.users.index', 'admin.users.create']))
