...
Route::group(['middleware' => ['auth']],function(){
		...
		Route::get('product/fetch/extended', 'Admins\ProductController@extendedwarrantyproductfetch')->name('extended.fetch.product');
...
->group(function() {
	...
	Route::delete('pages/destroy/{id}', 'PageController@destroy')->name('pages.destroy');
	...
	Route::get('page-items/edit/{id}', 'PageItemController@edit')->name('page-items.edit');
	Route::post('page-items/{id}', 'PageItemController@update')->name('page-items.update');
	Route::delete('page-items/destroy/{id}', 'PageItemController@destroy')->name('page-items.destroy');
	...
	Route::delete('faqs/destroy/{id}', 'FaqController@destroy')->name('faqs.destroy');
	...
	Route::post('contacts/update/{id}', 'ContactUsController@update')->name('contacts.update');
	Route::delete('contacts/destroy/{id}', 'ContactUsController@destroy')->name('contacts.destroy');
	...
	Route::delete('locations/destroy/{id}', 'LocationController@destroy')->name('locations.destroy');
	...
	Route::post('discount/update/{id}', 'DiscountController@update')->name('discount.update');
